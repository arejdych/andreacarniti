...
export const projects: Project[] = [
  ...
  },
  {
    ...
    cover: "02",
    summary:
      "The Tenant Portal turns building energy and utility sensor data into actionable insights for facility managers. I redesigned the core monitoring dashboard around real decisions managers make daily, working alongside a product manager and two engineers.",
    problem:
